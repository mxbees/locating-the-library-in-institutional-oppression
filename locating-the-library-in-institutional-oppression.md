...
He also notes that public libraries pretty have much failed miserably on this account by not being widely used &mdash; and that those who did use it were largely interested in entertainment[^23].
...
Notions of 'property' (esp. 'private property') are fundamental to capitalism. While the reduction of human beings &mdash; of Black people &mdash; to 'property' is the most extreme and final articulation of this logic, the notion of 'intellectual property' also represents one expression of this logic. Absolutely nothing is more natural to capitalism than reducing something like a creative work to 'property' that can and must be 'exploited'[^39].
