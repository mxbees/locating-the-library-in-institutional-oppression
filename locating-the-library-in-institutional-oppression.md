...
Libraries are, in the hearts and minds, of many people a cherished and much beloved institution. There are many of us with fond stories and memories of the worlds of imagination that libraries, via their shelves of books free for the taking, opened up to use. Beyond nurturing young people's love of reading, libraries also embody a certain set of values. As Neil Gaiman recently wrote:
...
With libraries holding such a necessary and seemingly unassailable position within our cultural imagination, how do we begin to understand their place within insitutional oppression?

Just as libraries represent notions of freedom, education, and the like, we also exist within a society and culture of great disparity and oppression. In one very simplistic sense, the existence of libraries themselves attest to this reality, since freely available resources wouldn't be necessary if it weren't the case that not everyone has equal access to these resources. Libraries themselves exist to address certain disparities within our society.

This paper is an initial exploration for the ways that libraries, in attempting to address inequity, actually entrench oppression. However, this isn't about the failures of libraries, rather it is about the way that certain values structure libraries such that they come to embody institutional oppression, rather than resist it.

In so doing, I will first discuss how the enligtenment is the ideological underpinings of the library and the historical processes that created the library as we know it today. Next, I analyze the contemporary polical location of libraries within our culture. This is then completed by exploring the implications of the library as institutionalized englightenment ideology using the three logics of white supremacy as proposed by Andrea Smith,[^57] as a way to demonstrate that libraries cannot be distinguished either from their historical roots nor from their contemporary context within a white supremacist settler state.

##2. Whence libraries? 

###2.1 The Enlightenment[^60] as Ideological Foundation for Libraries

In _Libraries and the Enlightenment_ Wayne Bivens-Tatum makes a compelling case for "the scientific and political principles of the Enlightenment provid[ing] the philosophical foundation for American academic and public libraries"[^8]. The _Stanford Encyclopedia of Philosophy_ describes the enlightenment as "the period in the history of western thought and culture, stretching roughly from the mid-decades of the seventeenth century through the eighteenth century, characterized by dramatic revolutions in science, philosophy, society and politics"[^58]. For the sake of this discussion, we are largely considering the social and political aspects of enlightenment thought.

We focus on the enlightenment and these parts of it because:

>The enduring legacy of the Enlightenment lives on in politics as much as in science, especially in the United States of America, which in some ways is the country best embodying Enlightenment principles.[^59]

He further identifies the key themes of enlightenment political/social/ethical thought as "individual liberty, equal rights, religious toleration, freedom of speech, freedom of the press, the right to education and political participation in a democracy"[^61].

One of the points he is very careful to make in the introduction of the book is that the historical realities of during the period of englightenment do not contradict the values and ideas of the enlightenment. The fact that the founders of the US were slave owners isn't relevant to the ideas and beliefs they espoused and held to, that "their historical blindness to their own contradictions hardly negates the universal appeal of enlightened political thought"[^62].

Insofar as you can buy into this argument, the problem remains that he has little evidence or reason for asserting that enlightened political thought, in actual fact, has universal appeal. Part of the point I'm making, in this exploration of libraries and institutional oppression, is that enlightenment values and political ideas do _not_ have universal appeal. And framing this way is, itself, a colonial act meant to enforce the current hegemony of the ideology. The reality is, colonialism has been resisted from the beginning and it continues to be resisted. Bivens-Tatum's responses to critics of the enlightenment has no space for anti-colonial/decolonialization critiques of enlightenment thought and values. 
...
###3.3 Contemporary Libraries and Liberalism
...
The way that libraries articulate this logic of white supremacy is expressed in the fourth statement in the ALA's Code of Ethics, "We respect intellectual property rights"[^38]. 

As stated in the preprint of "Property Rights and Capitalism in the _Oxford Handbook of Capitilism_, "property rights are a necessary but not sufficient condition for capitalism"[^51]. When discussig how private property resolves the tragedy of the commons they note, "through the right to exclude, private property rights transform common pool resources into private goods. Excludability, together with the right to control and claim to value, eliminates both problems"[^52].

This is an important distinction from how many non-Black conceptualizations focus on Black labour in settler states:

>Theories that attempt to triangulate Blackness into the Settler/Native antagonism in White settler states do so by positing Blackness as the labor force that helps make the settler landscape possible. It is true that Black labor literally tills, fences in and cultivates the settler’s land. However, this singular analysis both obscures the issue of Black fungibility and reduces Blackness to a mere tool of settlement rather than a constitutive element of settler colonialism’s conceptual order.[^53]

In attempting to understand how the logic of slavery informs and structures intellectual property, we can see from King that "the enslaved embody the abstract “interchangeability and replaceability” that is endemic to the commodity (Hartman, 1997, p. 21). Beyond, the captive body’s use as labor, the Black body has a figurative and metaphorical value that extends into the realm of the discursive and symbolic"[^54] and that "intellectual propery is extermely important for capitalism"[^55]. Lastly, "the overall trend in intellectual property protection is broadly correlated with the rise of capitalism. In fact, some institutional features associated with capitalism had to exist prior to the full development of intellectual property rights"[^56].

Thus, we can see that capitalism, as whole, rests on the logic of slavery and that intellectual property, as we know it today, is somewhat dependent on the existence of 'institutional features' of capitalism. As such, the ALA's avowed support for intellectual property entails support for capitalism and white supremacy, as one cannot currently 'respect intellectual property rights' without supporting the institutions of capitalism that gave rise to our current system and which, in turn, is fundamentally structured around the logic of slavery. 
...
How libraries enforce this logic of white supremacy should be rather obvious by this point. It has been noted many times within this paper that libraries were created and continue to be conceived as institutions designed for benefit of creating an informed citizenry for the sake of democrary. 
...
[^57]: Smith, Andrea. “Indigeneity, Settler Colonialism, White Supremacy - Centre for World Dialogue.” Global Dialogue 12, no. 2 (2010).

[^58]: Bristow, William. “Enlightenment.” Edited by Edward N. Zalta. The Stanford Encyclopedia of Philosophy, 2011. http://plato.stanford.edu/archives/sum2011/entries/enlightenment/.
